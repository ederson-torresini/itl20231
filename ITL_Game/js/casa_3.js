export default class casa_3 extends Phaser.Scene {
  constructor() {
    super("casa_3");
  }
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON("casa_3", "Assets/Map/Casas/casa_3.json");
  ...
  create() {
    ...
    this.map = this.make.tilemap({ key: "casa_3" });
  ...
  mostrar_painel() {
    ...
    this.botao_0 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/3", "0", {
          qos: 1,
        });
      });
    this.botao_1 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/3", "1", {
          qos: 1,
        });
      });
    this.botao_2 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/3", "2", {
          qos: 1,
        });
      });
    this.botao_3 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/3", "3", {
          qos: 1,
        });
      });
    this.botao_4 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/3", "4", {
          qos: 1,
        });
      });
      this.botao_5 = this.add
        ...
        .setInteractive()
        .on("pointerdown", () => {
          this.game.cliente_mqtt.publish("itl20231/casa/3", "5", {
            qos: 1,
          });
        });
