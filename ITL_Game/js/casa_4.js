export default class casa_4 extends Phaser.Scene {
  constructor() {
    super("casa_4");
  }
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON("casa_4", "Assets/Map/Casas/casa_4.json");
  ...
  create() {
    ...
    this.map = this.make.tilemap({ key: "casa_4" });
  ...
  mostrar_painel() {
    ...
    this.botao_0 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/4", "0", {
          qos: 1,
        });
      });
    this.botao_1 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/4", "1", {
          qos: 1,
        });
      });
    this.botao_2 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/4", "2", {
          qos: 1,
        });
      });
    this.botao_3 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/4", "3", {
          qos: 1,
        });
      });
    this.botao_4 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/4", "4", {
          qos: 1,
        });
      });
      this.botao_5 = this.add
        ...
        .setInteractive()
        .on("pointerdown", () => {
          this.game.cliente_mqtt.publish("itl20231/casa/4", "5", {
            qos: 1,
          });
        });
