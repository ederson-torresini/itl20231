export default class casa_5 extends Phaser.Scene {
  constructor() {
    super("casa_5");
  }
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON("casa_5", "Assets/Map/Casas/casa_5.json");
  ...
  create() {
    ...
    this.map = this.make.tilemap({ key: "casa_5" });
  ...
  mostrar_painel() {
    ...
    this.botao_0 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/5", "0", {
          qos: 1,
        });
      });
    this.botao_1 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/5", "1", {
          qos: 1,
        });
      });
    this.botao_2 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/5", "2", {
          qos: 1,
        });
      });
    this.botao_3 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/5", "3", {
          qos: 1,
        });
      });
    this.botao_4 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/5", "4", {
          qos: 1,
        });
      });
      this.botao_5 = this.add
        ...
        .setInteractive()
        .on("pointerdown", () => {
          this.game.cliente_mqtt.publish("itl20231/casa/5", "5", {
            qos: 1,
          });
        });
