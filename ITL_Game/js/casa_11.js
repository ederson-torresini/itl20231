export default class casa_11 extends Phaser.Scene {
  constructor() {
    super("casa_11");
  }
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON("casa_11", "Assets/Map/Casas/casa_11.json");
  ...
  create() {
    ...
    this.map = this.make.tilemap({ key: "casa_11" });
  ...
  mostrar_painel() {
    ...
    this.botao_0 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/11", "0", {
          qos: 1,
        });
      });
    this.botao_1 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/11", "1", {
          qos: 1,
        });
      });
    this.botao_2 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/11", "2", {
          qos: 1,
        });
      });
    this.botao_3 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/11", "3", {
          qos: 1,
        });
      });
    this.botao_4 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/11", "4", {
          qos: 1,
        });
      });
      this.botao_5 = this.add
        ...
        .setInteractive()
        .on("pointerdown", () => {
          this.game.cliente_mqtt.publish("itl20231/casa/11", "5", {
            qos: 1,
          });
        });
