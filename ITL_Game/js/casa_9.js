export default class casa_9 extends Phaser.Scene {
  constructor() {
    super("casa_9");
  }
  ...
  preload() {
    ...
    this.load.tilemapTiledJSON("casa_9", "Assets/Map/Casas/casa_9.json");
  ...
  create() {
    ...
    this.map = this.make.tilemap({ key: "casa_9" });
  ...
  mostrar_painel() {
    ...
    this.botao_0 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/9", "0", {
          qos: 1,
        });
      });
    this.botao_1 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/9", "1", {
          qos: 1,
        });
      });
    this.botao_2 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/9", "2", {
          qos: 1,
        });
      });
    this.botao_3 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/9", "3", {
          qos: 1,
        });
      });
    this.botao_4 = this.add
      ...
      .setInteractive()
      .on("pointerdown", () => {
        this.game.cliente_mqtt.publish("itl20231/casa/9", "4", {
          qos: 1,
        });
      });
      this.botao_5 = this.add
        ...
        .setInteractive()
        .on("pointerdown", () => {
          this.game.cliente_mqtt.publish("itl20231/casa/9", "5", {
            qos: 1,
          });
        });
