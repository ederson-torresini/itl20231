export default class casa1 extends Phaser.Scene {
  ...
  mostrar_painel () {
    ...
    this.botao_2 = this.add
      ...
      .setInteractive()
      .on('pointerdown', () => {
        this.game.cliente_mqtt.publish('itl20231/casa/1', '2', {
          qos: 1
        })
      })
    this.botao_3 = this.add
      ...
      .setInteractive()
      .on('pointerdown', () => {
        this.game.cliente_mqtt.publish('itl20231/casa/1', '3', {
          qos: 1
        })
      })
    this.botao_4 = this.add
      ...
      .setInteractive()
      .on('pointerdown', () => {
        this.game.cliente_mqtt.publish('itl20231/casa/1', '4', {
          qos: 1
        })
      })
    this.botao_5 = this.add
      ...
      .setInteractive()
      .on('pointerdown', () => {
        this.game.cliente_mqtt.publish('itl20231/casa/1', '5', {
          qos: 1
        })
      })
